...
shinyAppUI <- fluidPage(
  ...
  div(
    div(style="display:table-cell; vertical-align:top; width:23em; padding-right: 20px",
        h2(tags$b("VisualizeMapPoints")),
        hr(),
        div(div(style="display:inline-block",h4(tags$b("Select GIS Files:"))),div(style="display:inline-block",actionButton("help_gis",label="",icon=icon("circle-question"),class="help-button",style="height:0px;width:0px;padding:0px;padding-bottom:25px;border:none;background:none"))),
        div(style = "display:inline-block",
            ...
            shinyFiles::shinyFilesButton("button_bg", "Select Background File" , title = "Please Select File:", buttonType = "default", class = NULL, multiple = FALSE)
        ),
        ...
        h5("Selected Background File:"),
        div(style = "max-width: 23em; padding-bottom: 10px; overflow-wrap: break-word; font-size: 0.8em", textOutput("bg_file")),
  ...
  div(style = "display:flex",
    ...
    div(style = "width: 25%; padding:10px",
        div(
          div(style = "display:inline-block", h4(tags$b("Result Data:"))),
